...
async def async_get_config_entry_diagnostics(
    ...
    return {
        ...
        "parameters": _kort(
            meteo_data,
            (
                "cape", "cape_peak", "lifted_index", "cin",
                "lpi", "updraft", "wolkentop", "wolkenbasis",
                "schering_1km", "schering_3km", "schering_6km",
                "hodograaf", "kwartierdata", "li_waarden_in_antwoord", "spreiding", "ensemble",
                "verwachting", "verwachting_rang",
            ),
        ),
        "neerslag": {
            **_kort(
